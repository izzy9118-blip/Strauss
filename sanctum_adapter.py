#!/usr/bin/env python3
"""Forward-only Sanctum adapter boundary for the Strauss minister.

This wrapper does not replace adapter.py and does not certify doctrine. It exposes
Strauss through the generic Sanctum adapter transport while keeping context assembly
and minister-local validation inside the sovereign repository.
"""
