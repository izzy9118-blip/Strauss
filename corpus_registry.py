...
WITNESS_ONLY_TP_ITEMS: dict[str, dict[str, Any]] = {'CORPUS-SRC-104': {'status_id': 'CORPUS-STATUS-104',
...
def validate_registry(registry: dict[str, Any]) -> list[str]:
    ...
    if identity.get("version") != "1.17.0":
        errors.append("corpus registry identity.version must be 1.17.0")
    ...
    if termination.get("theologico_political_independent_study_state") != "INCOMPLETE_9_OF_19":
        errors.append("TP independent-study state must be INCOMPLETE_9_OF_19")
