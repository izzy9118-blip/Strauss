...
COMPLETE_TP_ITEMS: dict[str, dict[str, Any]] = {'CORPUS-SRC-101': {'status_id': 'CORPUS-STATUS-101',
                    'witness_id': 'CORPUS-WIT-101',
                    'study_id': 'CORPUS-STUDY-016',
                    'internal_study_id': 'PROGRESS-RETURN-STUDY-001',
                    'study_path': 'studies/theologico-political/progress-or-return/sequential-reconstruction.yaml',
 ...
 'CORPUS-SRC-102': {'status_id': 'CORPUS-STATUS-102',
 ...
 'CORPUS-SRC-103': {'status_id': 'CORPUS-STATUS-103',
                    ...
                    'reading_state': 'COMPLETE_FOR_REVIEWED_1997_COLLECTED_WITNESS',
                    'platform_reference': False},
 'CORPUS-SRC-104': {'status_id': 'CORPUS-STATUS-104',
                    ...
                    'reading_state': 'COMPLETE_FOR_REVIEWED_1997_COLLECTED_WITNESS',
                    'platform_reference': False},
 'CORPUS-SRC-105': {'status_id': 'CORPUS-STATUS-105',
                    ...
                    'platform_reference': False},
 'CORPUS-SRC-106': {'status_id': 'CORPUS-STATUS-106',
                    ...
                    'reading_state': 'COMPLETE_FOR_REVIEWED_1997_COLLECTED_WITNESS',
                    'platform_reference': False},
 'CORPUS-SRC-107': {'status_id': 'CORPUS-STATUS-107',
 ...
 'CORPUS-SRC-108': {'status_id': 'CORPUS-STATUS-108',
                    ...
                    'study_id': 'CORPUS-STUDY-013',
                    'internal_study_id': 'GENESIS-STUDY-001',
                    ...
                    'reading_state': 'COMPLETE_FOR_REVIEWED_1997_COLLECTED_WITNESS',
                    'platform_reference': False},
 'CORPUS-SRC-109': {'status_id': 'CORPUS-STATUS-109',
                    ...
                    'reading_state': 'COMPLETE_FOR_REVIEWED_1983_COLLECTED_WITNESS',
                    'platform_reference': False},
 'CORPUS-SRC-111': {'status_id': 'CORPUS-STATUS-111',
 ...
 'CORPUS-SRC-113': {'status_id': 'CORPUS-STATUS-113',
                    ...
                    'reading_state': 'COMPLETE_FOR_REVIEWED_1997_COLLECTED_WITNESS',
                    'platform_reference': False},
 'CORPUS-SRC-116': {'status_id': 'CORPUS-STATUS-116',
                    'witness_id': 'CORPUS-WIT-116',
                    'study_id': 'CORPUS-STUDY-015',
                    'internal_study_id': 'HOBBES-PREFACE-STUDY-001',
...
WITNESS_ONLY_TP_ITEMS: dict[str, dict[str, Any]] = {'CORPUS-SRC-110': {'status_id': 'CORPUS-STATUS-110',
 ...
 'CORPUS-SRC-112': {'status_id': 'CORPUS-STATUS-112',
                    ...
                    'container_file_size_bytes': 39287307,
                    'container_page_count': 526},
 'CORPUS-SRC-114': {'status_id': 'CORPUS-STATUS-114',
...
def validate_registry(registry: dict[str, Any]) -> list[str]:
    ...
    if identity.get("version") != "1.20.0":
        errors.append("corpus registry identity.version must be 1.20.0")
    ...
    expected_counts = {
        ...
        "study records": (len(study_ids), 19),
    ...
    expected_coverage = {
        ...
        "theologico_political_independent_item_studies_registered": 12,
    ...
    if termination.get("theologico_political_independent_study_state") != "INCOMPLETE_12_OF_19":
        errors.append("TP independent-study state must be INCOMPLETE_12_OF_19")
