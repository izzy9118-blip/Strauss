...
def validate_registry(registry: dict[str, Any]) -> list[str]:
    ...
    if identity.get("version") != "1.21.0":
        errors.append("corpus registry identity.version must be 1.21.0")
    ...
    if termination.get("theologico_political_independent_study_state") != "INCOMPLETE_13_OF_19":
        errors.append("TP independent-study state must be INCOMPLETE_13_OF_19")
